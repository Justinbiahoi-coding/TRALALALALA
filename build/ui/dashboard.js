...
export function initDashboardHub() {
    ...
    if (!media || !video || !hitarea || !muteButton)
        return;
...
export function renderDashboard(isLoading = false) {
    ...
    const displayName = (user === null || user === void 0 ? void 0 : user.displayName) || (user === null || user === void 0 ? void 0 : user.username) || "Nhà Lữ Hành";
    return `
